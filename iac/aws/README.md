...
> **Branches.** This tree lives on [`extra/iac-aws-terragrunt`](https://github.com/tan-demo/demo-devops/tree/extra/iac-aws-terragrunt).
> The graded submission, Golden Rule harness, and AWS **architecture diagram** are on
> [`main`](https://github.com/tan-demo/demo-devops/tree/main) — see
> [`docs/aws-architecture.svg`](../../docs/aws-architecture.svg) there.
...
> `iac/aws` tree is an **optional extension** that implements the production diagram — not required
> by the assignment, kept on this branch to demonstrate depth without bloating the reviewer path.
